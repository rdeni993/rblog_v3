	...
	<div class="col-sm-9 right-side">
		...
		<form method="POST" action="<?php echo site_url('login/user_login'); ?>">
			<div class="user-login-page">
				<div class="login-box v3-login-box">
					<h1>Login</h1>
					<hr />
					...
					<br />
					<a href="<?php echo site_url('login/reset'); ?>" class="btn btn-link">Izgubila/o sam lozinku!</a><br />
					...
					<?php elseif( @$_GET["error"] == 3 ): ?>
						<div class="alert" role="alert">
							<span class="glyphicon glyphicon-remove"></span> Vi niste administrator!
						</div>
					<?php endif; ?>
				</div>
			</div>
