		...
		<div class="col-sm-8 dashboard">
			...
			<form method="post" action="<?php echo site_url('admin/update'); ?>">
				...
				<div class="row">
					...
					<div class="col-sm-12">
						<input name="post_title" type="text" class="form-control input-lg" placeholder="Title..." value="<?php echo $post->post_title ?>" />
						<br />
					</div>
					...
					<div class="col-sm-12">
						...
						<textarea name="post_content" id="cke">
<<<<<<< HEAD
...
>>>>>>> 1833af15b69c183c571db5cb8023f379e6e7b86f
					...
					<div class="col-sm-4">
						...
						<div class="form-group">
							...
							<select name="post_category" class="form-control" id="sel1">
								<option value="<?php echo $post->post_category; ?>" selected><?php echo $post->post_category; ?></option>
								<?php if(!empty($cats)): ?>
					...
					<div class="col-sm-4">
						...
						<div class="form-group">
							...
							<select name="post_privacy" class="form-control" id="sel1">
								<option value="<?php echo $post->post_privacy; ?>" selected><?php echo $post->post_privacy; ?></option>
					...
					<div class="col-sm-4">
						...
						<div class="form-group">
							...
							<input type="hidden" name="post_featured" value="<?php echo $post->post_featured_img_path; ?>" />
						</div> 
					</div>
					<div class="col-sm-4">
						<label>Tags</label>
						<br />
						<textarea name="post_tags" class="form-control"><?php echo $post->post_tags; ?></textarea>
						<br />
