	...
	<div class="row">
		...
		<div class="col-sm-8 dashboard">
			...
			<div class="alert alert-success">
			  	<strong><span class="glyphicon glyphicon-ok"></span> Success!</strong> Your file is now uploaded!
			</div>
			<?php else: ?>
			<div class="alert alert-danger">
			  	<strong><span class="glyphicon glyphicon-warning-sign"></span> Failed!</strong> Your file is not uploaded!
			</div>
		<?php endif; ?>
