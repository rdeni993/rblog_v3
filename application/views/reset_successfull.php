		...
		<div class="row v3-blog-post v3-profile">
			<div class="col-sm-12 text-center">
				...
				<div class="alert alert-success" role="alert">
					<p>Zahtjev za resetovanjem lozinke je primljen! Uskoro cemo vam proslijediti mail sa vasim podacima. Ukoliko mail ne stigne u roku 24h molimo resetirajte ponovo!</p>
				</div>
			</div>
		</div>
		<!-- Page Content EOF -->
